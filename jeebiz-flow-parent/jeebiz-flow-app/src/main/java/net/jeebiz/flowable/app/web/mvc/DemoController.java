/**
 */
package net.jeebiz.flowable.app.web.mvc;
...
import net.jeebiz.cloud.api.webmvc.BaseMapperController;
import net.jeebiz.cloud.api.webmvc.Result;
import net.jeebiz.flowable.app.dao.entities.DemoModel;
import net.jeebiz.flowable.app.service.IDemoService;
import net.jeebiz.flowable.app.setup.data.LogConstant;
import net.jeebiz.flowable.app.web.vo.DemoVo;
...
public class DemoController extends BaseMapperController{
	...
	public String toNewDemo(@RequestBody DemoVo demoVo, Model model) throws Exception {
		//model.addAttribute("xxxList", getDemoService().getxxxList());
