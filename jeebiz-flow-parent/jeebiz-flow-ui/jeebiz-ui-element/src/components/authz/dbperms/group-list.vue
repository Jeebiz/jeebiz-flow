    ...
    <div v-if="isShow">
      ...
      <el-table
          ...
          <el-table-column label="操作">
            <template slot-scope="scope">
              <el-button size="medium" type="text" v-if="hasPermission('authz-dbperms-group:renew')" @click="edit(scope.row.id)">编辑</el-button>
              <el-button size="medium" type="text" v-if="hasPermission('authz-dbperms-group:delete')" @click="deleteList(scope.row.id)" style="color:#f56c6c"
              >删除</el-button>
            </template>
          </el-table-column>
        </el-table>
