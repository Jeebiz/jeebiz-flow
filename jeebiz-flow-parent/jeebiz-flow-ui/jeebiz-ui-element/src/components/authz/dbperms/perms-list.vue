    ...
    <div v-if="isShow">
      ...
      <el-table
          ...
          <el-table-column label="操作">
            <template slot-scope="scope">
              <el-button size="medium" v-if="hasPermission('authz-dbperms:renew')" type="text" @click="edit(scope.row.id)">编辑</el-button>
              <el-button size="medium" v-if="hasPermission('authz-dbperms:delete')" type="text" @click="deleteList(scope.row.id)" style="color:#f56c6c"
              >删除</el-button>
            </template>
          </el-table-column>
      </el-table>
