 ...
 */
//编辑器路径
var editorPath = _path+"/webjars/zftal-ui-v5/plugins/kindeditor",
	themesPath = _path + "/webjars/zftal-ui-v5/plugins/kindeditor/themes/",
	pluginsPath = _path + "/webjars/zftal-ui-v5/plugins/kindeditor/plugins/"
	//样式文件路径
	//处理文件上传的访问路径
	//uploadJson = _path+'/editor/fileUpload.zf',
	uploadJson = _path+'/filemgr/kineditor/upload.zf',
	//浏览服务器上文件的访问路径
	//fileManagerJson = editorPath+'/files.jsp';
	//fileManagerJson = _path+'/editor/fileManage.zf';
	fileManagerJson = _path+'/filemgr/kineditor/fileManage.zf';
